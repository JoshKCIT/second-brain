...
- The HTML is for preview only; it is not Confluence storage format and cannot be pasted into Confluence directly. For actual Confluence push, use `publish-to-confluence.prompt.md`.
