...
Check `wiki/workspace-projects/{slug}/03-architecture/adrs/` for existing ADRs. Determine the next sequential 4-digit number (0001, 0002, etc.). If the directory does not exist, create it and start at 0001.

## ADR file location

`wiki/workspace-projects/{slug}/03-architecture/adrs/{NNNN}-{decision-slug}.md`
...
- Append to `wiki/log.md`:
  ...
  - Status: draft
  - Stakeholders: {list}
  - Path: wiki/workspace-projects/{slug}/03-architecture/adrs/{NNNN}-{decision-slug}.md
  ```
