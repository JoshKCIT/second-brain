...
description: Use proactively when reviewing researcher transcripts, meeting notes, or claims about improving Second Brain. Extracts atomic claims, grounds them against existing project docs, runs skeptical product-impact scoring, and writes research-review artifacts without modifying canonical standards.
model: inherit
readonly: false
is_background: false
---

# Research Review Adjudicator for Second Brain
...
- A transcript under `raw/transcripts/**`
- Relevant project docs:
  ...
  - `docs/architecture-rationale.md`
  - `docs/roadmap.md`
  - `wiki/research/claim-register.md`, if present
