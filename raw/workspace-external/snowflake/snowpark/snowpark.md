...
vendor: snowflake
topic: snowpark
fetched_at: 2026-06-10T06:40:16Z
revalidate_after: 2026-07-10T06:40:16Z
...
| --- | --- | --- |
| Java | [Snowpark Developer Guide for Java](https://docs.snowflake.com/developer-guide/snowpark/java/index) | [Snowpark Library for Java API Reference](https://docs.snowflake.com/developer-guide/snowpark/reference/java/index.html) |
| Python | [Snowpark Developer Guide for Python](https://docs.snowflake.com/developer-guide/snowpark/python/index) | [Snowpark Library for Python API Reference](https://docs.snowflake.com/developer-guide/snowpark/reference/python/latest/index) |
| Scala | [Snowpark Developer Guide for Scala](https://docs.snowflake.com/developer-guide/snowpark/scala/index) | [Snowpark Library for Scala API Reference](https://docs.snowflake.com/developer-guide/snowpark/reference/scala/2.12/com/snowflake/snowpark/index.html) |

## Download

You can download the Snowpark library for any of the three supported languages. For downloads, see [Snowpark Client Download](https://developers.snowflake.com/snowpark/) (Snowflake Developer Center).
...
In comparison to using the [Snowflake Connector for Spark](https://docs.snowflake.com/user-guide/spark-connector), developing with Snowpark includes the following benefits:
...
Although you can still use a string to specify the SQL statement to execute, you benefit from features like [intelligent code completion](https://en.wikipedia.org/wiki/Intelligent_code_completion) and type checking when you use the native language constructs provided by Snowpark.
