---
source_url: https://docs.snowflake.com/en/user-guide/data-load-snowpipe
vendor: snowflake
topic: snowpipe
fetched_at: 2026-06-10T06:43:31Z
revalidate_after: 2026-07-10T06:43:31Z
...
The following table indicates the cloud storage service support for automated Snowpipe and Snowpipe REST API calls from Snowflake accounts hosted on each [cloud platform](https://docs.snowflake.com/user-guide/intro-cloud-platforms):
...
For more information, see [Automate continuous data loading with cloud messaging](https://docs.snowflake.com/user-guide/data-load-snowpipe-auto) and [Overview of the Snowpipe REST endpoints to load data](https://docs.snowflake.com/user-guide/data-load-snowpipe-rest-overview).
...
- [CREATE PIPE](https://docs.snowflake.com/sql-reference/sql/create-pipe)
- [ALTER PIPE](https://docs.snowflake.com/sql-reference/sql/alter-pipe)
- [DROP PIPE](https://docs.snowflake.com/sql-reference/sql/drop-pipe)
- [DESCRIBE PIPE](https://docs.snowflake.com/sql-reference/sql/desc-pipe)
- [SHOW PIPES](https://docs.snowflake.com/sql-reference/sql/show-pipes)
