---
source_url: https://docs.snowflake.com/en/sql-reference/sql/create-file-format
vendor: snowflake
topic: file-format
...
- [Variant syntax](#label-create-or-alter-file-format-syntax): Creates a named file format if it doesn’t exist or alters an existing file format.

See also:

[ALTER FILE FORMAT](https://docs.snowflake.com/sql-reference/sql/alter-file-format), [DROP FILE FORMAT](https://docs.snowflake.com/sql-reference/sql/drop-file-format), [SHOW FILE FORMATS](https://docs.snowflake.com/sql-reference/sql/show-file-formats), [DESCRIBE FILE FORMAT](https://docs.snowflake.com/sql-reference/sql/desc-file-format)

[COPY INTO <location>](https://docs.snowflake.com/sql-reference/sql/copy-into-location), [COPY INTO <table>](https://docs.snowflake.com/sql-reference/sql/copy-into-table), [CREATE OR ALTER <object>](https://docs.snowflake.com/sql-reference/sql/create-or-alter)
...
Creates a new named file format if it doesn’t already exist, or transforms an existing file format into the one defined in the statement. A CREATE OR ALTER FILE FORMAT statement follows the syntax rules of a CREATE FILE FORMAT statement and has the same limitations as an [ALTER FILE FORMAT](https://docs.snowflake.com/sql-reference/sql/alter-file-format) statement.

Supported alterations include changes to the [formatTypeOptions](#label-create-file-format-formattypeoptions) and COMMENT properties. You can’t alter the TYPE property.
...
Specifies that the file format persists only for the duration of the [session](https://docs.snowflake.com/user-guide/session-policies) that you created it in. A temporary file format is dropped at the end of the session.
...
Specifies the format of the input files (for data loading) or output files (for data unloading). Depending on the format type, you can specify additional format-specific options. For more information, see [Format Type Options](#label-create-file-format-formattypeoptions) (in this topic).
...
For more information about CSV, see [Usage Notes](#usage-notes) in this topic. For more information about JSON and the other semi-structured file formats, see [Introduction to loading semi-structured data](https://docs.snowflake.com/user-guide/semistructured-intro).
...
- All limitations of the [ALTER FILE FORMAT](https://docs.snowflake.com/sql-reference/sql/alter-file-format) command apply.
...
> 
> If you must recreate a file format after it has been linked to one or more external tables, you must recreate each of the external tables (using CREATE OR REPLACE EXTERNAL TABLE) to reestablish the association. Call the [GET\_DDL](https://docs.snowflake.com/sql-reference/functions/get_ddl) function to retrieve a DDL statement to recreate each of the external tables.
...
Alter *my\_csv\_format* so that it defines the following rules for data files and unsets the comment:
