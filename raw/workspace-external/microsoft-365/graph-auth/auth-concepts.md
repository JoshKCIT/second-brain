...
Illustration of delegated and app-only access scenarios in the Microsoft identity platform.
...
[Microsoft Graph exposes granular permissions](https://learn.microsoft.com/en-us/graph/permissions-reference) that control access to Microsoft Graph resources, like users, groups, and mail. Two types of permissions are available for the supported [access scenarios](#access-scenarios):
