---
source_url: https://learn.microsoft.com/en-us/microsoft-365-copilot/extensibility/declarative-agent-architecture
vendor: microsoft-365-copilot
topic: declarative-agent-architecture
...
![Diagram of the architecture of a declarative agent.](https://learn.microsoft.com/en-us/microsoft-365-copilot/extensibility/assets/images/declarative-agents/declarative-agents-architecture-diagram.png)

Diagram of the architecture of a declarative agent.
...
| Infrastructure | Consider whether the Microsoft 365 infrastructure meets your current needs. | Using existing Microsoft 365 app ecosystem features: policies, governance, catalog, publication, audit, retention, data loss prevention (DLP). | Privatized network/storage needs. |
...
![Diagram of declarative agent data flow showing sequential steps from initial prompt to response, with developer-controlled components in blue.](https://learn.microsoft.com/en-us/microsoft-365-copilot/extensibility/assets/images/declarative-agents/data-flow-declarative-agents.png)

Diagram of declarative agent data flow showing sequential steps from initial prompt to response, with developer-controlled components in blue.
...
Declarative agents operate within specific technical limits that you must consider when you design solutions.
...
Declarative agents provide significant benefits for organizations that want to implement AI solutions within existing Microsoft 365 environments:
...
- **Access to Microsoft capabilities**: Provides direct access to Microsoft capabilities, including advanced AI features and productivity integrations.
...
Declarative agents work best for scenarios that align with their architectural strengths and that avoid areas where limitations become problematic.

### Optimal scenarios

Declarative agents are optimal for:
