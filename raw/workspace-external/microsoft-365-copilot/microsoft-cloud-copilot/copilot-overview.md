---
source_url: https://learn.microsoft.com/en-us/microsoft-cloud/dev/copilot/overview
vendor: microsoft-365-copilot
topic: microsoft-cloud-copilot
fetched_at: 2026-06-10T07:13:31Z
revalidate_after: 2026-09-08T07:13:31Z
...
![A diagram showing the adopt, extend, and build capabilities of Copilot across the Microsoft Cloud.](https://learn.microsoft.com/en-us/microsoft-cloud/dev/copilot/isv/media/copilot-across-microsoft-cloud.png)
...
| **Customization (temperature, max\_tokens, metaprompts)** | Low | Medium | High |
...
![A diagram showing the adopt options for a Copilot across the Microsoft Cloud.](https://learn.microsoft.com/en-us/microsoft-cloud/dev/copilot/isv/media/copilot-across-microsoft-cloud-adopt.png)
...
![Screenshot of Microsoft Copilot enterprise.](https://learn.microsoft.com/en-us/microsoft-cloud/dev/copilot/isv/media/microsoft-copilot.png)
...
- [Copilot with commercial data protection](https://learn.microsoft.com/en-us/bing-chat-enterprise/overview)
- [Privacy and protections](https://learn.microsoft.com/en-us/bing-chat-enterprise/privacy-and-protections)
...
- [Microsoft Copilot for Azure](https://learn.microsoft.com/en-us/azure/copilot/overview)
...
![Using Copilot for Microsoft 365.](https://learn.microsoft.com/en-us/microsoft-cloud/dev/copilot/isv/media/copilot-for-m365.png)
...
- [Overview of Copilot in Microsoft Fabric](https://learn.microsoft.com/en-us/fabric/get-started/copilot-fabric-overview)
...
- [Microsoft Fabric Workload Development Kit](https://learn.microsoft.com/en-us/fabric/workload-development-kit/development-kit-overview)
...
- [Build a canvas app for a real estate solution with Copilot in Power Apps](https://learn.microsoft.com/en-us/training/modules/build-canvas-app-real-estate-power-apps-copilot/)
...
- [Build flows for a real estate solution using Copilot in Power Automate](https://learn.microsoft.com/en-us/training/modules/build-real-estate-power-automate-copilot/)
...
- [Get started with Microsoft Copilot for Security](https://learn.microsoft.com/en-us/training/paths/security-copilot-and-ai)
...
![A diagram showing extend options for a Copilot across the Microsoft Cloud.](https://learn.microsoft.com/en-us/microsoft-cloud/dev/copilot/isv/media/copilot-across-microsoft-cloud-extend.png)
...
![A diagram showing Microsoft Copilot interacting with a plugin.](https://learn.microsoft.com/en-us/microsoft-cloud/dev/copilot/isv/media/api-data-is-processed-by-copilot.png)
...
![A diagram showing the key tasks that a Power Platform connector performs.](https://learn.microsoft.com/en-us/microsoft-cloud/dev/copilot/isv/media/power-platform-connector.png)
...
- [Power Platform Connectors Overview](https://learn.microsoft.com/en-us/connectors/connectors)
- [Create a Custom Power Platform Connector from Scratch](https://learn.microsoft.com/en-us/connectors/custom-connectors/define-blank)
...
2. Defining a schema for the external content
3. Managing external content that's imported into Microsoft 365

![A diagram showing the key tasks that a Microsoft Graph connector performs.](https://learn.microsoft.com/en-us/microsoft-cloud/dev/copilot/isv/media/graph-connector.png)

Learn more:

- [Build your First Custom Microsoft Graph Connector](https://learn.microsoft.com/en-us/graph/connecting-external-content-build-quickstart)
- [Publish your Custom Microsoft Graph Connector](https://learn.microsoft.com/en-us/graph/custom-connector-sdk-sample-publish)
...
- [Build Message Extensions using Bot Framework](https://learn.microsoft.com/en-us/microsoftteams/platform/messaging-extensions/build-bot-based-message-extension)
...
![A diagram showing the build options for creating a custom Copilot.](https://learn.microsoft.com/en-us/microsoft-cloud/dev/copilot/isv/media/copilot-across-microsoft-cloud-build.png)
...
![A diagram showing how Azure AI Search can be used with Azure OpenAI to chat against your own data and documents.](https://learn.microsoft.com/en-us/microsoft-cloud/dev/copilot/isv/media/chat-with-your-data.png)

To chat with your own data using Azure OpenAI and Azure AI Search in [Azure AI Foundry portal](https://ai.azure.com/?cid=learnDocs), see [Deploy a web app for chat on your data](https://learn.microsoft.com/en-us/azure/ai-studio/tutorials/deploy-chat-web-app) and [Build your own copilot using prompt flow](https://learn.microsoft.com/en-us/azure/ai-studio/tutorials/deploy-copilot-ai-studio).

Learn more:

- [Azure AI services Documentation, Samples, and Resources](https://learn.microsoft.com/en-us/azure/developer/intro/azure-ai-for-developers?pivots=python)
- [Azure AI Foundry Documentation](https://learn.microsoft.com/en-us/azure/ai-studio)
- [Quickstart: Chat with Azure OpenAI Models Using Your Own Data](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/use-your-data-quickstart)
...
- [Microsoft Copilot Studio Overview](https://learn.microsoft.com/en-us/microsoft-copilot-studio/fundamentals-what-is-copilot-studio)
- [Quickstart: Create and deploy a Microsoft Copilot Studio Copilot](https://learn.microsoft.com/en-us/microsoft-copilot-studio/fundamentals-get-started)