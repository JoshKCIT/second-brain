...
vendor: github
topic: copilot-models-pricing
fetched_at: 2026-06-10T07:14:00Z
revalidate_after: 2026-09-08T07:14:00Z
...
- **Billing usage report**: Filter by `workflow_path` using the value `dynamic/agents/copilot-pull-request-reviewer`. See [Billing reports reference](https://docs.github.com/en/billing/reference/billing-reports).

## Model multipliers for annual Copilot Pro and Copilot Pro+ subscribers

Copilot Pro and Copilot Pro+ subscribers on **existing annual billing plans** using the **request-based billing** model have different model multipliers. See [Model multipliers for annual plans on request-based billing (legacy)](https://docs.github.com/en/copilot/reference/copilot-billing/model-multipliers-for-annual-plans).