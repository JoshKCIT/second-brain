...
[View a markdown version of this page](https://docs.aws.amazon.com/timestream/latest/developerguide/what-is-timestream.md)
...
- **[Tutorial](https://docs.aws.amazon.com/timestream/latest/developerguide/getting-started.db-w-sample-data.html) -** To create a database populated with sample data sets and run sample queries.
- **[Amazon Timestream for LiveAnalytics concepts](https://docs.aws.amazon.com/timestream/latest/developerguide/concepts.html) -** To learn essential Timestream for LiveAnalytics concepts.
- **[Accessing Timestream for LiveAnalytics](https://docs.aws.amazon.com/timestream/latest/developerguide/accessing.html) -** To learn how to access Timestream for LiveAnalytics using the console, AWS CLI, or API.
- **[Quotas](https://docs.aws.amazon.com/timestream/latest/developerguide/ts-limits.html) -** To learn about quotas on the number of Timestream for LiveAnalytics components that you can provision.
