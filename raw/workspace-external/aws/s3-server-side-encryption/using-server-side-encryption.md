---
source_url: https://docs.aws.amazon.com/AmazonS3/latest/userguide/UsingServerSideEncryption.html
vendor: aws
topic: s3-server-side-encryption
...
[View a markdown version of this page](https://docs.aws.amazon.com/AmazonS3/latest/userguide/UsingServerSideEncryption.md)
...
To configure server-side encryption by using the object creation REST APIs, you must provide the `x-amz-server-side-encryption` request header. For information about the REST APIs, see [Using the REST API](https://docs.aws.amazon.com/AmazonS3/latest/userguide/specifying-s3-encryption.html#SSEUsingRESTAPI).
