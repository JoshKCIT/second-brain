---
source_url: https://docs.aws.amazon.com/appconfig/latest/userguide/what-is-appconfig.html
vendor: aws
topic: appconfig-overview
...
[View a markdown version of this page](https://docs.aws.amazon.com/appconfig/latest/userguide/what-is-appconfig.md)
...
![](https://www.youtube.com/watch?v=rL_e6W6SlMM)
...
3. Sends a copy of the data to AWS AppConfig Agent to be read by your application. This copy is called the *deployed data*.
