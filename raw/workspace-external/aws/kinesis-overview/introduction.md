---
source_url: https://docs.aws.amazon.com/streams/latest/dev/introduction.html
vendor: aws
topic: kinesis-overview
...
[View a markdown version of this page](https://docs.aws.amazon.com/streams/latest/dev/introduction.md)
