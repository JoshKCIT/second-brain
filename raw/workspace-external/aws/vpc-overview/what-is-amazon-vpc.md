...
[View a markdown version of this page](https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.md)
...
Use a [transit gateway](https://docs.aws.amazon.com/vpc/latest/userguide/extend-tgw.html), which acts as a central hub, to route traffic between your VPCs, VPN connections, and Direct Connect connections.
...
Connect your VPCs to your on-premises networks using [AWS Virtual Private Network (Site-to-Site VPN)](https://docs.aws.amazon.com/vpc/latest/userguide/vpn-connections.html).
