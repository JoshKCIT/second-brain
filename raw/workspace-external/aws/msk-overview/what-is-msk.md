---
source_url: https://docs.aws.amazon.com/msk/latest/developerguide/what-is-msk.html
vendor: aws
topic: msk-overview
...
[View a markdown version of this page](https://docs.aws.amazon.com/msk/latest/developerguide/what-is-msk.md)

Welcome to the Amazon MSK Developer Guide - Amazon Managed Streaming for Apache Kafka

[What is Amazon MSK?](#what-is-msk-intro)
...
- Create an MSK Provisioned cluster by following the [Get started using Amazon MSK](https://docs.aws.amazon.com/msk/latest/developerguide/getting-started.html) tutorial.
- Dive deeper into the functionality of MSK Provisioned in [What is MSK Provisioned?](https://docs.aws.amazon.com/msk/latest/developerguide/msk-provisioned.html).
- Run Apache Kafka without having to manage and scale cluster capacity with [MSK Serverless](https://docs.aws.amazon.com/msk/latest/developerguide/serverless.html).
- Use [MSK Connect](https://docs.aws.amazon.com/msk/latest/developerguide/msk-connect.html) to stream data to and from your Apache Kafka cluster.
- Use [MSK Replicator](https://docs.aws.amazon.com/msk/latest/developerguide/msk-replicator.html) to reliably replicate data across MSK Provisioned clusters in different or the same AWS Regions.
