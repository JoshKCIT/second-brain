---
source_url: https://docs.aws.amazon.com/dms/latest/userguide/Welcome.html
vendor: aws
topic: dms-overview
fetched_at: 2026-06-10T06:24:09Z
revalidate_after: 2026-08-09T06:24:09Z
...
[View a markdown version of this page](https://docs.aws.amazon.com/dms/latest/userguide/Welcome.md)
...
![Getting started with AWS DMS](https://docs.aws.amazon.com/images/dms/latest/userguide/images/datarep-Welcome.png)

###### References

- AWS Regions that support AWS DMS – For information about what AWS Regions support AWS DMS, see [Working with an AWS DMS replication instance](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_ReplicationInstance.html).
...
- AWS DMS supports nearly all of today's most popular DBMS engines as source endpoints. For more information, see [Sources for data migration](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Source.html).
- AWS DMS provides a broad coverage of available target engines. For more information, see [Targets for data migration](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Target.html).
