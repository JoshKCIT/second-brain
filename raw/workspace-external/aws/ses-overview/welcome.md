---
source_url: https://docs.aws.amazon.com/ses/latest/dg/Welcome.html
vendor: aws
topic: ses-overview
...
[View a markdown version of this page](https://docs.aws.amazon.com/ses/latest/dg/Welcome.md)

What is Amazon SES? - Amazon Simple Email Service

[Benefits](#why-use-ses) [Related services](#ses-and-aws) [Pricing](#ses-pricing)
...
- You can send email from Amazon EC2 by using an [AWS SDK](https://aws.amazon.com/tools/#sdk), by using the [Amazon SES SMTP interface](https://docs.aws.amazon.com/ses/latest/dg/send-email-smtp.html), or by making calls directly to the [Amazon SES API](https://docs.aws.amazon.com/ses/latest/APIReference/).
